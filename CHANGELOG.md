...
| --- | --- | --- |
| [17.0.9](docs/changelog/17.0.9.md) | 2026-08-22 | Vouchers narrowed to what can actually go where the picker is, and reaching tenants that installed before the fix; fields that hold several choices; articles sold in variants; a store of two shelves; and a module that draws its own index |
